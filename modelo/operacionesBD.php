        ...
        if ($this->nIdFormularioD == 0)
            ...
            if ($oAccesoDatos->conectar()) {
                ...
                if ($arrRS) {
                    ...
                    $this->fTel = $arrRS[0][6];
                    $this->fTel2 = $arrRS[0][7];
                    $this->fIdProyecto = $arrRS[0][8];
                    $bRet = true;
                }
            }
        }
...
class operacionesFormularioC extends formularioc
{
    ...
    function modificar()
    {
        ...
        if (
            $this->cidCredito == "" or $this->cNombre == "" or
            $this->cApePat == "" or $this->cCurp == "" or
            $this->cNoImss == "" or $this->cTel == "" or
            $this->cCodCre == 0
        ) {
    ...
    function buscarTodos()
    {
        ...
        if ($oAccesoDatos->conectar()) {
            $sQuery = "SELECT cNombre, cApePat, cApeMat
            , cCurp, cNImss, cCodCre1, cTel
                FROM credito
                ORDER BY idCredito";
            $arrRS = $oAccesoDatos->ejecutarConsulta($sQuery);
...
class operacionesVivienda extends vivienda
{
    ...
    function insertar()
    {
        ...
        if (
            $this->vidVivienda == "" or $this->vNHabi == "" or
            ...
            if ($oAccesoDatos->conectar()) {
                ...
                '" . $this->vMedidas . "','" . $this->vPrecio . "'," . $this->vIdZona1 . ",
                " . $this->vIdProt1 . ");";
                $nAfectados = $oAccesoDatos->ejecutarComando($sQuery);
    ...
    function buscarTodos()
    {
        ...
        if ($oAccesoDatos->conectar()) {
            $sQuery = "SELECT vNHabi, vNPisos, vMedidas
